...
print("Note: NST function currently runs on a single thread and may take several hours to complete. Potential for at least 50x speed up by parallel processing and/or moving to GPU.")
```
